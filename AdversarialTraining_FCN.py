...
experiment = Experiment("m487mKQwNTqFF4z7aZRX3Xv19", project_name="AdversarialTraining_FCN", log_env_gpu=True)
...
from Models import FCN, Stanford_Adversarial
...
class SS_GAN(object):
    ...
    def _save_weights(self):
        ...
        """
        self.generator.save_weights('output' + '/AdvFCN.h5')
    ...
    def _plot_results_and_save(self, g_loss, g_acc, d_loss, d_acc, steps, val_steps, val_loss, val_acc):
        ...
        plt.legend()
        plt.savefig('output/' + 'AdvFCN_plot.png')
...
if __name__ == '__main__':
    ...
    Semantic_GAN = SS_GAN(image_shape=(256, 256),
                          numClasses=num_of_Classes,
                          pretrained_weights='FCN_weights.h5',
                          palette=palette,
                          channels=[3, 3])
